...
public class Reactor<T> implements Server<T> {
    ...
    private final Supplier<BidiMessagingProtocolImpl<T>> protocolFactory; //bidi
    private final Supplier<MessageEncDecImpl<T>> readerFactory; //bidi
    ...
    public Reactor(
            ...
            Supplier<MessageEncDecImpl<T>>readerFactory) {
    ...
    private void handleAccept(ServerSocketChannel serverChan, Selector selector) throws IOException {
        ...
        final NonBlockingConnectionHandler<T> handler = new NonBlockingConnectionHandler<>(readerFactory.get(),
                protocolFactory.get(), clientChan, this, connections, conID.getAndIncrement());
